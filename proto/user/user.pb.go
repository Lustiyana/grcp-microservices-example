...
const file_proto_user_user_proto_rawDesc = "" +
	...
	"\x05total\x18\x02 \x01(\x05R\x05total2\xbb\x01\n" +
	"\vUserService\x129\n" +
	"\n" +
	...
	"\tListUsers\x12\x16.user.ListUsersRequest\x1a\x17.user.ListUsersResponseB\x1fZ\x1dgrpc-microservices/proto/userb\x06proto3"
